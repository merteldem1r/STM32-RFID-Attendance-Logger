...
// CS (Chip Select function macros)
#define MFRC522_CS_LOW()   HAL_GPIO_WritePin(MFRC522_CS_PORT, MFRC522_CS_PIN, GPIO_PIN_RESET)
#define MFRC522_CS_HIGH()  HAL_GPIO_WritePin(MFRC522_CS_PORT, MFRC522_CS_PIN, GPIO_PIN_SET)
